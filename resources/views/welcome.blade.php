        ...
        <div class="row">
            <div class="col-sm-4 pt-4 mt-1">
                <div id="feed" class="px-3">
                    <h1 class="d-flex justify-content-between "><span>Daily Feed</span> <img src="assets/refresh.svg"
                            alt="refresh" width="20"></h1>
                    <div class="row mb-3">
                        <div class="col-sm-2 pe-0">
                            <img src="{{ asset('assets/profile1.svg') }}" alt="" class="img-fluid"
                                width="30">
                        </div>
                    ...
                    <div class="row mb-3">
                        <div class="col-sm-2 pe-0">
                            <img src="{{ asset('assets/profile2.svg') }}" alt="" class="img-fluid"
                                width="30">
                        </div>
                        <div class="col-sm-9 ps-0">
            ...
            <div class="col-sm-4">
                ...
                <div id="buttons">
                    ...
                    <div
                        style="background-color: rgba(0, 0, 0, 0.8); padding: 20px; border-radius: 10px; display: inline-block;">
                        <p style="font-family: 'VT323', monospace; color: #fff;">
                            Pixelchain lets you unleash your creativity and craft dazzling pixel art masterpieces.
                            Sketch retro game
                            sprites, intricate patterns, or simple doodles with vibrant colors and intuitive tools. Turn
                            your digital
                    ...
                    <div>
                        <a href="https://x.com/pixelchain_" class="button"
                            style="font-family: 'VT323', monospace;">Twitter</a>
                        <a href="https://t.me/pixelchainsol" class="button"
                            style="font-family: 'VT323', monospace;">Telegram</a>
                        <a href="https://example.com" class="button"
                            style="font-family: 'VT323', monospace;">Pump.fun</a>
                    </div>
                </div>
                            ...
                            <div class="d-flex flex-column align-items-center text-center"> <img
                                ...
                                <div class="mt-3">
                                    ...
                                    <div class="d-flex justify-content-center">
                                        <img src="{{ asset('assets/instragram.svg') }}" alt="in" width="60"
                                            style="margin-top: -5px;">
                                        <img src="{{ asset('assets/twitter.svg') }}" alt="tw" width="60">
                                        <img src="{{ asset('assets/facebook.svg') }}" alt="fb" width="57"
